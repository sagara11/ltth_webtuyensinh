      ...
      <!-- /.box-body -->
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update Danh Mục</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Seo Description</label>
                     <textarea name="seo_keyword" class="form-control" id="exampleInputEmail1" placeholder="Description">{{$category->seo_description}}</textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input checked type="checkbox" name="publish" checked >
                    @else
