                    ...
                    <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input name="search" type="text" class="form-control" id="name" value="{{$search != '' ? $search : ''}}" placeholder="Tên bài viết">
                        </div>
                    </div>
                ...
                <table class="table table-hover " >
                    ...
                    <tbody>
                        ...
                        <tr id="detail_{{ $temp->id }}">
                            ...
                            <td>{{isset($temp->categories->name) ? $temp->categories->name : ''}}</td>
