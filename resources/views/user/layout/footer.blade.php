<footer class="container d-flex bg-light p-3">
    <div class="row">
        <ul class="col-lg-3 info-contain list-unstyled">
            <li>
        ...
        <div class="col-lg-3 info-contain list-unstyled">
            <h6><b>Liên kết</b></h6>
